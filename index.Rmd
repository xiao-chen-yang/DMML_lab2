...
dist(X) #X: each row is an observation and each column is a variable
...
# metric MDS
library(smacof)
mds(delta, type=c("ratio","interval") #delta: disimilarity
...
# metric MDS
mds(delta, type="ordinal") #delta: disimilarity
